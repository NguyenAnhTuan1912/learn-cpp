...
#define DATE_FORMAT_FULL_PATTERN "(\\w+), (\\d{1,2}\\/\\d{1,2}\\/\\d{4}) (\\d{2}:\\d{2}:\\d{2})"
#define DATE_FORMAT_NORMAL_PATTERN "(\\d{1,2}\\/\\d{1,2}\\/\\d{1,4}) (\\d{2}:\\d{2}:\\d{2})"
#define DATE_FORMAT_ONLY_DATE_PATTERN "(\\d{1,2}\\/\\d{1,2}\\/\\d{4})"
